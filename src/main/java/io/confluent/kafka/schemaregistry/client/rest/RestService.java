...
public class RestService {
  ...
  private static final TypeReference<Schema> GET_SCHEMA_BY_ID_RESPONSE_TYPE =
  ...
  public Schema getId(int id) throws IOException, RestClientException {
    return getId(DEFAULT_REQUEST_PROPERTIES, id);
  }

  public Schema getId(Map<String, String> requestProperties,
  ...
  public Schema getVersion(String subject, String version) throws IOException, RestClientException {
